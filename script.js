...
window.loadDishViewer=function(btn){
  const dv=btn.closest('.dish-view');if(!dv)return;
  dv.classList.add('loaded');
  const mv=dv.querySelector('model-viewer'),glb=dv.dataset.glb||'';
